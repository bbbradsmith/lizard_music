...
0. Export music data with music_export.py
1. Build music.s with ca65 and include its object in your link.
2. Titles from the FTM files will become MUSIC_[TITLE] and SOUND_[TITLE] enums in output\data_music_enums.inc
3. Include music.inc in your project's assembly files that need to interface with the music engine.
4. Build and link output\data_music.s into your project.
...
0. Export music data with music_export.py
1. Run demo/build_demo.bat to rebuild output/demo.nes
2. Run output/demo.nes to use the demo.
